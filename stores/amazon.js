...
export default async function amazon(
	...
	try {
		...
		if (res && res.status == 200) {
			...
			let title = document_.querySelector("#productTitle").innerHTML.trim().slice(0, 150);
			let inventory = document_.querySelector("#add-to-cart-button");
			let image = document_.querySelector("#landingImage").getAttribute("data-old-hires");
