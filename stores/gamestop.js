...
export default async function gamestop(url, interval) {
	...
	try {
		...
		if (res && res.status == 200) {
			...
			let productInfo = document_.querySelectorAll("script");
			let title = document_.querySelectorAll(".product-name");
			let inventory = null,
				productId = null;
			let image = document_.querySelectorAll(".product-main-image-gallery");
